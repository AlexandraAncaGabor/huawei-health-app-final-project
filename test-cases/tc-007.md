# **[TC-007] Adding another device to the app**

### **Description**

The new device is successfully added to the app when paired by the user.
...
| 7   | Press "Pare" on the watch          | The new watch and the phone are now paired.                            |
| 8   | Observe the paired devices         | The new watch is seen in the devices area                              |
